    ...
    <table id="">
        ...
        <tr >
			...
			<td class="shipping">${paper.paperrank }</td>
             <td class="operation">
             <a href="${pageContext.request.contextPath }/uppaperrank.action?paperID=${paper.paperID}">提升试卷等级</a>&nbsp;&nbsp;&nbsp;
             <a href="${pageContext.request.contextPath }/downpaerrank.action?paperID=${paper.paperID}">降低试卷等级</a>&nbsp;&nbsp;&nbsp;
